package com.sosunmuhammed.gallerist.handler;
...
public class GlobalExceptionHandler {
    ...
    private ResponseEntity<ApiError<Map<String, List<String>>>> handleMethodNotValidException(MethodArgumentNotValidException ex, WebRequest request){
